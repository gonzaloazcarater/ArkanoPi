...
int ConfiguraInicializaSistema (TipoSistema *p_sistema) {
	...
	// A completar por el alumno...
		...
		tmr_t* tmr_actualizacion_juego = tmr_new (tmr_actualizacion_juego_isr);
		sistema.arkanoPi.tmr_actualizacion_juego = tmr_actualizacion_juego;
...
int main () {
	...
	fsm_trans_t arkanoPi[] = {
		...
		{ WAIT_PUSH, CompruebaPausa, WAIT_PAUSE, ParaJuego},
		{ WAIT_PAUSE, CompruebaPausa, WAIT_PUSH, ContinuaJuego},
		{-1, NULL, -1, NULL },
	};
